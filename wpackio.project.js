...
module.exports = {
	// Project Identity
	appName: 'seventyTwoHours', // Unique name of your project
	type: 'theme', // Plugin or theme
	slug: 'seventytwohours', // Plugin or Theme slug, basically the directory name under `wp-content/<themes|plugins>`
